...
@Component({
  ...
  imports: [ConfirmMatchModalComponent, ManualMatchModalComponent, PartialMatchModalComponent, AcompteModalComponent, DisplayCurrencyPipe],
  template: `
    ...
    <tbody>
      ...
      @for (tx of transactions(); track tx.id) {
        <tr class="tx-row" [class.tx-confirmed]="tx.statut === 'CONFIRMED'"
          ...
          <td class="num-col amount-cell">{{ tx.montant | displayCurrency : tx.devise }}</td>
