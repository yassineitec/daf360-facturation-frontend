...
const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/fact/clients',        label: 'Clients',        icon: 'building',     permission: 'FACT_VIEW_CLIENTS'        },
  ...
  { path: '/fact/billing/approval', label: 'File d\'approbation', icon: 'approval', permission: 'FACT_VALIDATE_RF'       },
  { path: '/fact/cost/approval',   label: 'Approbation Coûts',  icon: 'approval',    permission: 'FACT_APPROVE_COST_L1'    },
  { path: '/fact/suppliers',       label: 'Fournisseurs',        icon: 'storefront', permission: 'FACT_MANAGE_SUPPLIERS'   },
];
...
const ICONS: Record<string, string> = {
  ...
  building:     `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="18" rx="2"/><path d="M8 21V7"/><path d="M16 21V7"/><path d="M2 12h20"/></svg>`,
  ...
  approval:    `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>`,
  storefront:  `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l1-6h16l1 6"/><path d="M3 9a2 2 0 0 0 4 0M7 9a2 2 0 0 0 4 0M11 9a2 2 0 0 0 4 0M15 9a2 2 0 0 0 4 0"/><path d="M5 9v11h14V9"/><rect x="9" y="14" width="6" height="6"/></svg>`,
};
